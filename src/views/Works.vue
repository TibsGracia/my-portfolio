  ...
  data: () => ({
    works: [
      ...
      },
      {
        ...
        description:
          "PN Tasking Generator is a web application used only for the educators of Passerelles numeriques that allows them to easly generate a tasking form for their students that is also printable.",
        technology: [
          "Angular 2",
          "Node js",
          "Express js",
