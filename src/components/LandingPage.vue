...
<div>
  <section>
    <v-parallax src="https://free4kwallpapers.com/uploads/originals/2015/10/27/minimalist--wallpaper.jpg" height="500">
      <v-layout column align-center justify-center class="white--text">
        <!-- <img src="@/assets/vuetify.png" alt="Vuetify.js" height="200"> -->
        <h1 class="white--text mb-2 display-2">Hi Everyone!</h1>
